# Runtime Review — verified-gambler-fallacy-mc-p03
...
- **Template:** `verified-gambler-fallacy-mc-p03`
- **Topic:** `long-run`
- **Skills:** `long-run-vs-single-trial`, `independence`
- **Retrieval form:** `definition`

## Problem 1 — verified-gambler-fallacy-mc-p03-p01

- **Instance id:** `verified-gambler-fallacy-mc-p03:4126551075`
- **Difficulty:** 760

# Runtime Review — verified-gambler-fallacy-mc-p01
...
- **Template:** `verified-gambler-fallacy-mc-p01`
- **Topic:** `long-run`
- **Skills:** `long-run-vs-single-trial`, `independence`
- **Retrieval form:** `definition`

## Problem 1 — verified-gambler-fallacy-mc-p01-p01

- **Instance id:** `verified-gambler-fallacy-mc-p01:1068915428`
- **Difficulty:** 860

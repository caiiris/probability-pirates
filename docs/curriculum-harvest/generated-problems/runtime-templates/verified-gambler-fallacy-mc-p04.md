# Runtime Review — verified-gambler-fallacy-mc-p04
...
- **Template:** `verified-gambler-fallacy-mc-p04`
- **Topic:** `long-run`
- **Skills:** `long-run-vs-single-trial`, `independence`
- **Retrieval form:** `definition`

## Problem 1 — verified-gambler-fallacy-mc-p04-p01

- **Instance id:** `verified-gambler-fallacy-mc-p04:891047577`
- **Difficulty:** 840

...
export const howLikely: Lesson = {
  ...
  slots: [
...

    {
      ...
      prompt: 'What are the chances that you win the lottery? That you meet your soulmate? Or that two people in your class share a birthday?',
      body: [
      ...
      variants: [
        {
          ...
          interactionKind: 'tap-outcomes',
          source: 'd6',
          prompt: 'How many ways are there to roll a single six-sided die? Tap every face it can land on to count them.',
          expectedOutcomes: ['1', '2', '3', '4', '5', '6'],
          afterNote: 'There are six ways to roll a six-sided die.',
          feedbackCorrect: 'On a fair die, each of those six faces is equally likely, one chance in six.',
          ...
          feedbackByWrongValue: {
            ...
            duplicate: 'Each face is one outcome. Tap a face once to collect it, or tap again to remove it.',
          },
          explanation:
...

    {
      ...
      prompt: 'Probability is how likely you are to get what you want, out of all the ways things could turn out.',
      body: [
      ...
      variants: [
        {
          ...
          afterNote: 'This fraction you just worked out tells us how likely something is to happen.',
          ...
          feedbackByWrongAnswer: {
            ...
            '6/1': 'That fraction is upside down. Favorable ways go on top, the total on the bottom.',
            '5/1': 'That fraction is upside down. Favorable ways go on top, the total on the bottom.',
      ...
      variants: [
        {
          ...
          denominatorLabel: 'ways in total',
          feedbackCorrect: 'Three even faces (2, 4, 6) out of six faces in total, so 3/6, which is the same as 1/2.',
          feedbackDefault: 'Tap the even faces to count them: 2, 4, 6. Then divide by the total number of faces.',
          feedbackByWrongAnswer: {
            ...
            '6/6': 'That would mean every roll is even, which is not true. Only some faces are even.',
          },
          explanation:
      ...
      variants: [
        {
          ...
          feedbackByOption: {
            ...
            equal: 'Not equal: an even number has three favorable faces (2, 4, 6) while a 5 has just one.',
          },
          explanation:
...

    {
      ...
      prompt: 'Every probability sits between 0 and 1. It is never less than 0, and never more than 1.',
      derivation: {
      ...
      variants: [
        {
          ...
          interactionKind: 'fill-fraction',
          prompt: 'Now use the definition. What is the probability of rolling a number greater than 4 on one fair die?',
          numerator: 2,
          denominator: 6,
          numeratorLabel: 'ways to roll above 4',
          denominatorLabel: 'ways in total',
          feedbackCorrect: 'Two faces are greater than 4 (the 5 and the 6) out of six in total, so 2/6, the same as 1/3.',
          feedbackDefault: 'Which faces are greater than 4? Count them, then divide by the total number of faces.',
          feedbackByWrongAnswer: {
            ...
            '6/2': 'That fraction is upside down. Favorable ways go on top, the total on the bottom.',
          },
          explanation:
      ...
      variants: [
        {
          id: 'd67-fourteen',
          interactionKind: 'fill-fraction',
          prompt: 'Now imagine a wild 67-sided die, with faces numbered 1 to 67. What is the probability of rolling a 14?',
          numerator: 1,
          denominator: 67,
          numeratorLabel: 'ways to roll a 14',
          denominatorLabel: 'ways in total',
          feedbackCorrect: 'One face is a 14, out of 67 faces in total, so 1/67. The formula does not care how big the die gets.',
          ...
          feedbackByWrongAnswer: {
            ...
            '1/14': 'The 14 is the face you want, not the total. How many faces does this die have?',
            '67/1': 'That fraction is upside down. Favorable ways go on top, the total on the bottom.',
            '14/1': 'That fraction is upside down. Favorable ways go on top, the total on the bottom.',
      ...
      variants: [
        {
          ...
          context: 'Captain Pascal rolls two dice and adds them. He wins if the total is 7. You win if the total is 2.',
          showDiceRoller: true,
          options: [
      ...
      variants: [
        {
          id: 'what-to-count',
          interactionKind: 'multiple-choice',
          prompt: 'To find the probability of rolling a total of 7, which fraction should you build?',
          options: [
            ...
            { id: 'rolls', label: 'Rolls that total 7 (like 3 and 4), over every roll two dice can make' },
            { id: 'literal', label: '7 over 12' },
          ],
          correctOptionId: 'rolls',
          feedbackCorrect: 'Yes. Favorable rolls on top, all the rolls on the bottom, the same move as one die. Go count the rolls that make 7.',
          feedbackDefault: 'Favorable ways on top, all the ways on the bottom. What are the ways for two dice?',
          feedbackByOption: {
            totals: 'The 11 totals are not equally likely, so you cannot count them as equal ways. The equal ways are the rolls of the two dice.',
            literal: 'Those numbers do not match anything here. You want favorable rolls over all the rolls.',
      ...
      variants: [
        {
          id: 'sum-seven',
          interactionKind: 'grid-event',
          prompt: "Let's look at all the ways you can roll two dice. Tap every cell where the dice sum to 7.",
          rows: 6,
          cols: 6,
        ...
        },
        {
          id: 'sum-six',
          interactionKind: 'grid-event',
          prompt: "Let's look at all the ways you can roll two dice. Tap every cell where the dice sum to 6.",
          rows: 6,
          cols: 6,
          correctCells: SUM_TO_SIX_CELLS,
          liveCounterTemplate: '{count} / 36',
          feedbackCorrect: '5 rolls make a total of 6. Out of the 36 rolls you will count next, that is 5 out of 36.',
...

    {
      ...
      prompt: 'You found that 6 rolls make a total of 7. To turn that into a probability, and to settle Pascal\u2019s game, you need the total number of rolls.',
      body: [
        'Each result is a pair: what the first die shows, and what the second shows.',
      ],
      derivation: {
...

    {
      ...
      body:
        'Two dice land 36 equally likely ways, but the totals are not equally likely. Therefore, you are more likely to get a 7, which settles Captain Pascal\u2019s game for good!\n\nIn the coming lessons, you\u2019ll pick up probability and counting principles that build up to the big questions we started with.',

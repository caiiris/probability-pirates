      ...
      <div className="mx-auto max-w-lg px-4 py-10">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            Soon this is where you'll see how your learning is really going. Beyond XP and streaks,
            it shows where you're strong, where you're stuck, and what to revisit next.
          </p>
        </div>

...
export const CAPTAIN_LINES: Record<CaptainContext, string[]> = {
  welcome: [
    "Ahoy, {name}! I'm Captain Pascal. Chance is a strange sea — let's learn to read it together.",
    "Welcome aboard, {name}. Every great navigator started with one lesson. Shall we?",
    "Glad to have you, {name}. Probability looks choppy from shore — it's calmer once we're sailing.",
  ],
  allCaught: [
